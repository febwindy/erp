[@override name="title"]学生创建[/@override]
...
[@override name="content"]
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">学生创建</li>
        </ol>
    </section>

    <section class="container content">
        <div class="row">
            <form role="form" class="form-horizontal" action="/student/create" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="date" class="form-control" id="birthDate" name="birthDate"
                               required="true" placeholder="请输入学生名" value="${student.birthDate}">
